...
export function Hero() {
  ...
  return (
    <section className="max-w-container-max mx-auto px-margin-mobile md:px-gutter py-section-gap grid grid-cols-1 lg:grid-cols-2 gap-16 items-center overflow-hidden">
      ...
      <motion.div 
        className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] flex gap-4 justify-center items-center"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <motion.div variants={imageVariants} className="w-full md:w-1/3 h-full md:h-3/4 bg-surface rounded-2xl p-4 flex flex-col justify-end relative shadow-sm overflow-hidden md:translate-y-8">
        ...
        <motion.div variants={imageVariants} className="hidden md:flex w-1/3 h-5/6 bg-surface rounded-2xl p-4 flex-col justify-end relative shadow-sm overflow-hidden -translate-y-8">
        ...
        {/* Tertiary Image - Hidden on mobile */}
        <motion.div variants={imageVariants} className="hidden md:flex w-1/3 h-3/4 bg-surface rounded-2xl p-4 flex-col justify-end relative shadow-sm overflow-hidden translate-y-4">
